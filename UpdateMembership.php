...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<li><a href="PurchaseMembership.php">Purchase Membership</a></li>
        <li class="active"><a href="UpdateMembership.php">Update Membership</a></li>
...
<form action="UpdateMembership-Process.php" method="post">
<div class="rcorners">
<p>Update Membership</p>

<p>Please select the membership you purchased</p>
