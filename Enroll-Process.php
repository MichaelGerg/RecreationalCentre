  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="Enroll.php">Enroll</a></li>
...
$sql = "INSERT INTO `Enrolls` (`MID`, `Cnum`, `Dname`) SELECT '{$MID}' AS `MID`, '{$ids[2]}' AS `Cnum`, `Dname` FROM `Instructor_Works` WHERE `IID`='{$ids[3]}'";
...
if ($conn->query($sql) === TRUE) {
 ...
 echo "<br>";
 echo "<br>";
 echo '<a href="Enroll.php" class="glow">Please try again</a>';
}
 ?>
</p>
</div>
