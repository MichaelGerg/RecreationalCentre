...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<li class="active"><a href="DeleteMembership.php">Delete Membership</a></li>
...
<form action="DeleteMembership-Process.php" method="post">
<div class="rcorners">

 <p>Select Membership to delete (CANNOT BE UNDONE)</p>
<?php
include 'connect.php';
$conn = OpenCon();
$result = $conn->query("select * from PurchasedMemberships");
...
unset($Type, $DateCreated, $ExpiryDate);
 $Type = $row['Type'];
 $DateCreated = $row['DateCreated'];
 $ExpiryDate = $row['ExpiryDate'];

 echo
'<option value="'.$Type.', '.$DateCreated.', '.$ExpiryDate.'">'.$Type.', '.$DateCreated.', '.$ExpiryDate.'</option>';
}
