...
$conn = OpenCon();
$sql = "select M.name from MemberInfo M where not exists (select * from Classes_Offers C  where not exists (select E.MID from Enrolls E where E.MID = M.MID and E.Cnum = C.Cnum)) ";
myTable($conn,$sql);
?>
